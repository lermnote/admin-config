...
For the smallest copyable setup, start with [docs/quick-start.md](/docs/quick-start.md), then use this example when you want a theme-owned reference with multiple containers.
